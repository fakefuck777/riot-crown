...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display-2xl': ['clamp(2rem, 5vw, 5rem)', { lineHeight: '0.88', letterSpacing: '0.02em' }],
        'display-xl':  ['clamp(1.5rem, 4vw, 3.5rem)',  { lineHeight: '0.9',  letterSpacing: '0.03em' }],
        'display-lg':  ['clamp(1.2rem, 3vw, 2.5rem)',  { lineHeight: '0.92', letterSpacing: '0.04em' }],
